                ...
                <div class="row main ">
                        <div class="main-login main-center masthead  text-white ">
                                ...
                                <form class="Register" method="get" action="">
                                    <h2 class="masthead-subheading mb-0">My Profile</h2>
                                            <br>    
                                        <div class="form-group">
                                                <label for="name" class="cols-sm-2 control-label">My Name</label>
                                        ...
                                        <div class="form-group">
                                                <label for="email" class="cols-sm-2 control-label">My Email</label>
                                                <div class="cols-sm-10">
                                                        <div class="input-group">
                                        ...
                                        <div class="form-group">
                                                <label for="username" class="cols-sm-2 control-label">My Mobile No.</label>
                                                <div class="cols-sm-10">
                                                        <div class="input-group">
                                        ...
                                        <div class="form-group">
                                                <label for="city" class="cols-sm-2 control-label">My City</label>
                                                <div class="cols-sm-10">
                                                        <div class="input-group">
